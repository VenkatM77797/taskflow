    ...
    <aside className="glass-panel relative z-20 flex h-screen w-72 flex-col border-r p-4">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={logout}
            className="rounded-xl p-2 text-neutral-500 transition hover:bg-neutral-100 dark:text-neutral-400 dark:hover:bg-neutral-800"
            title="Logout"
          >
            <LogOut size={18} />
          </button>
      ...
      <nav className="space-y-1">
        ...
        <NavItem
          href="/dashboard/week"
          icon={<CalendarDays size={18} />}
          active={pathname === '/dashboard/week'}
          label="This week"
        />
        <NavItem
      ...
      <div className="mt-8 flex-1 overflow-y-auto pr-1">
        <div className="mb-3 flex items-center gap-2 text-xs font-black uppercase tracking-wide text-neutral-400 dark:text-neutral-500">
        ...
        <form onSubmit={createProject} className="mt-3 flex gap-2">
          <input
            ...
            className="min-w-0 flex-1 rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-900 outline-none transition placeholder:text-neutral-400 focus:border-brand-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder:text-neutral-500"
            placeholder="New project"
          />

          <button
            disabled={busy}
            className="rounded-xl bg-neutral-900 p-2 text-white transition hover:bg-neutral-700 disabled:opacity-60 dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-300"
        ...
        <div className="mb-3 mt-8 flex items-center gap-2 text-xs font-black uppercase tracking-wide text-neutral-400 dark:text-neutral-500">
          <Tag size={15} /> Labels
        </div>
